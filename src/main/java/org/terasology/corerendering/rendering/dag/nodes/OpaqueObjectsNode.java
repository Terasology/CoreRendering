...
/**
 * This node renders the opaque (as opposed to semi-transparent) objects present in the world. This node -does not-
 * render the landscape.
 * <p>
 * Objects to be rendered must be registered as implementing the interface RenderSystem and take advantage of the
 * RenderSystem.renderOpaque() method, which is called in process().
 */
public class OpaqueObjectsNode extends AbstractNode implements WireframeCapable {
    ...
    private final EnableFaceCulling faceCullingStateChange;
