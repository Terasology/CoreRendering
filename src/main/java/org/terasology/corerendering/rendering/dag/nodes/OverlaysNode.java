 ...
 * <p>
 * Objects to be rendered as overlays must be registered as implementing the interface RenderSystem and must take
 * advantage of the RenderSystem.renderOverlay() method, which is called in process().
 */
public class OverlaysNode extends AbstractNode implements WireframeCapable {
     ...
     * Enables wireframe.
     * <p>
     * Notice that this is just a request and wireframe gets enabled only after the rendering task list has been
     * refreshed. This occurs before the beginning of next frame or earlier.
     */
     ...
     * Disables wireframe.
     * <p>
     * Notice that this is just a request and wireframe gets disabled only after the rendering task list has been
     * refreshed. This occurs before the beginning of next frame or earlier.
     */
