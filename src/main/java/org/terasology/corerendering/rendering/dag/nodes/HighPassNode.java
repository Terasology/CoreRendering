...
/**
 * An instance of this class generates a high pass image out of the color content of the GBUFFER and stores the result
 * into HIGH_PASS_FBO_URI, for other nodes to take advantage of it.
 */
public class HighPassNode extends ConditionDependentNode {
    ...
    private final float highPassThreshold = 0.05f;
    ...
    /**
     * Generates a high pass image out of the color content of the GBUFFER and stores it into the HIGH_PASS_FBO_URI.
     * <p>
