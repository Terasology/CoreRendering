...
public class OpaqueBlocksNode extends AbstractNode implements WireframeCapable, PropertyChangeListener {
    ...
    /**
     * Renders the world's opaque blocks, effectively, the world's landscape. Does not render semi-transparent blocks,
     * i.e. semi-transparent vegetation.
     * <p>
     * If RenderingDebugConfig.isRenderChunkBoundingBoxes() returns true this method also draws wireframe boxes around
     * chunks, displaying their boundaries.
     * <p>
    ...
    private void renderChunkBoundingBox(RenderableChunk chunk, Vector3f chunkPosition, Vector3fc cameraPosition) {
        ...
        GL11.glTranslatef(chunkPositionRelativeToCamera.x, chunkPositionRelativeToCamera.y,
                chunkPositionRelativeToCamera.z);
