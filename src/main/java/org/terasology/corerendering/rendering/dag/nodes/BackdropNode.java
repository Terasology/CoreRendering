 ...
 * <p>
 * In this implementation the backdrop consists of a spherical mesh (a skysphere) on which two sky textures are
 * projected, one for the day and one for the night. The two textures cross-fade as the day turns to night and
 * viceversa.
 * <p>
...
public class BackdropNode extends AbstractNode implements WireframeCapable {
    ...
    private final SetWireframe wireframeStateChange;
